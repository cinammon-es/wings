...
import (
	...
	"github.com/cinammon-net/wings/events"
	"github.com/cinammon-net/wings/remote"
	"github.com/cinammon-net/wings/server/filesystem"
...
type Server struct {
	...
	// fetched from the Cinammon Server instance each time the server process is
